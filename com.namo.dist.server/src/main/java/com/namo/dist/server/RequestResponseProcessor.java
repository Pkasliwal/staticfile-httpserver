...
/**
 * Request response processor interface defining processor contract and state/context that gets passed on to next processor. 
 */
public interface RequestResponseProcessor {
	
	/**
	 * Responsible for verifying if request context response code is not set ie 0 then go ahead with the exchange request processing based on the defined request headers.
